...
<!-- badges: start -->
[![R-CMD-check](https://github.com/patrekieta/CDCdata/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/patrekieta/CDCdata/actions/workflows/R-CMD-check)
